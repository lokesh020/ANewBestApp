...
import { AccessibilityInfo, PanResponder, Animated, View, Text, Image, Pressable, TouchableOpacity } from 'react-native';
...
class ExpandableCalendar extends Component {
  ...
  renderKnob() {
    const { position } = this.state;
    const iconName = position === POSITIONS.OPEN ? "chevron-up" : "chevron-down"
    return (
      <Pressable style={[this.style.knobContainer,{height:30,backgroundColor:"#F8F6F6"}]} onPress = {this.toggleCalendar}>
