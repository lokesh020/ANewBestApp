...
class VideoPlayer extends Component {
    ...
    this.setState({ renderError: true }, () => {
      ...
      switch (true) {
        ...
        case typeof error === 'object':
          ...
          break
        default:
          type = Alert.alert('Oops!', 'There was an error playing this media, please try again later.', [{ text: 'Close' }])
          break
      }
      return type
    })
  ...
  animToFullscreen(height) {
    let conditionalHeight = (Platform.OS=="ios") ? height : height
    Animated.parallel([
      Animated.timing(this.animFullscreen, { toValue: conditionalHeight, duration: 200,useNativeDriver:false }),
      Animated.timing(this.animInline, { toValue: conditionalHeight, duration: 200,useNativeDriver:false })
    ]).start()
  }
